$(document).ready(
    (function() {
        i18next.addResourceBundle("en_p", "translation", {
            ...
            i18next.addResourceBundle("uz_p", "translation", {
            ...
            i18next.addResourceBundle("ru_p", "translation", {
            ...
            i18next.addResourceBundle("gb_p", "translation", {
            ...
            $("#lng-resources").on("click", ".lng-nav li a", (function() {
                var e = $(this),
                    n = e.data("lng");
                i18next.changeLanguage(n, (function(e, n) {
                    $(".translate-text").localize()
                })), e.parent("li").siblings("li").children("a").removeClass("active"), e.addClass("active"), $("#lng-resources").find(".lng-dropdown .dropdown-menu a").removeClass("active");
                var a = $("#lng-resources").find('.lng-dropdown .dropdown-menu a[data-lng="' + n + '"]').addClass("active");
                $("#lng-resources #dropdown-active-item").html(a.html())
            })), $("#lng-resources").on("click", ".lng-dropdown .dropdown-menu a", (function() {
                var e = $(this),
                    n = e.data("lng");
                i18next.changeLanguage(n, (function(e, n) {
                    $(".translate-text").localize()
                })), $("#lng-resources .lng-nav li a").removeClass("active"), $('#lng-resources .lng-nav li a[data-lng="' + n + '"]').addClass("active"), $("#lng-resources").find(".lng-dropdown .dropdown-menu a").removeClass("active"), e.addClass("active"), $("#lng-resources #dropdown-active-item").html(e.html())
            }))
    }));