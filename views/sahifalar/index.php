...
<div class="header">
        ...
        <p style="margin-left: 70%;">
            <?= Html::a('Yangilik kiritish', ['create'], ['class' => 'btn btn-info btn-min-width mr-1 mb-1 btn-block']) ?>
        </p>
    </div>
    <br>  
                                        ...
                                        'buttons' => [
                                         'view' => function ($url, $model) {
                                          ...
                                          'urlCreator' => function ($action, $model, $key, $index) {
                                            if ($action === 'view') {
                                                $url =Url::to('/sahifalar/view/'.$model->id);
                                                return $url;
                                            }

                                            if ($action === 'update') {
                                                $url =Url::to('/sahifalar/update/'.$model->id);
                                                return $url;
                                            }
                                            if ($action === 'delete') {
                                                $url ='#';
