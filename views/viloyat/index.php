...
<div class="header">
    ...
    <p style="margin-left: 70%;">
        <?= Html::a('Yangi viloyat qo\'shish', ['create'], ['class' => 'btn btn-info btn-min-width mr-1 mb-1 btn-block']) ?>
    </p>
</div>
                        ...
                        'columns' => [
                            ...
                            [
                              ...
                              'urlCreator' => function ($action, $model, $key, $index) {
                                if ($action === 'view') {
                                    $url =Url::to('/viloyat/view/'.$model->viloyat_id);
                                    return $url;
                                }

                                if ($action === 'update') {
                                    $url =Url::to('/viloyat/update/'.$model->viloyat_id);
                                    return $url;
                                }
                                if ($action === 'delete') {
                                    $url ='#';
