...
namespace app\components\http\debug;
...
class HttpClientPanel extends Panel
{
     ...
     */
    private $_httpClient = 'app\components\http\Client';
    ...
    public function init()
    {
        $this->actions['request-execute'] = [
            'class' => 'app\components\http\debug\RequestExecuteAction',
            'panel' => $this,
        ];
    }
    ...
    public function getSummary()
    {
        ...
        return Yii::$app->view->render('@app/components/http/debug/views/summary', [
            'timings' => $this->calculateTimings(),
            'panel' => $this,
    ...
    public function getDetail()
    {
        ...
        return Yii::$app->view->render('@app/components/http/debug/views/detail', [
            'panel' => $this,
    ...
    public function save()
    {
        ...
        $messages = $target->filterMessages($target->messages, Logger::LEVEL_PROFILE, [
            'app\components\http\Transport::*',
            'app\components\http\CurlTransport::*',
            'app\components\http\StreamTransport::*',
        ]);
