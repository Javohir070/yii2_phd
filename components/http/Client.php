...
class Client extends Component
{
     ...
     */
    private $_transport = 'app\components\http\StreamTransport';
    ...
    public function getFormatter($format)
    {
        static $defaultFormatters = [
            self::FORMAT_JSON => 'app\components\http\JsonFormatter',
            self::FORMAT_URLENCODED => [
                'class' => 'app\components\http\UrlEncodedFormatter',
            ...
            self::FORMAT_XML => 'app\components\http\XmlFormatter',
        ];
    ...
    public function getParser($format)
    {
        static $defaultParsers = [
            self::FORMAT_JSON => 'app\components\http\JsonParser',
            self::FORMAT_URLENCODED => 'app\components\http\UrlEncodedParser',
            self::FORMAT_RAW_URLENCODED => 'app\components\http\UrlEncodedParser',
            self::FORMAT_XML => 'app\components\http\XmlParser',
        ];
